...
public class SimpleGitHubReader {

	public static void main(String[] args) throws Throwable {
		String link = "https://github.com/openfootball/es-espana/blob/master/2016-17/liga-i.txt";
		// String link =
		...
		System.out.println(resultsParser(crunchifyResponse));
	...
	public static String resultsParser(String rawContent) {

		String startKeyword = "js-file-line\">";
		String stopkeyword = "</td";
		String parsedResult = "";
		...
		while ((currentStarIndex = rawContent.indexOf(startKeyword,
				currentStopIndex)) != -1) {
			currentStopIndex = rawContent
					.indexOf(stopkeyword, currentStarIndex);
			String substring = rawContent.substring(currentStarIndex
					+ startKeyword.length(), currentStopIndex);
			parsedResult += substring + lineBreak;
		}
		return parsedResult;
	}
}
